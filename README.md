...
1. **Artifacts** — é o que faz o widget aparecer.
...
2. **Busca na web** — só é usada no modo "tema/tópico" (item 5B e 5C).
...
- **PDF longo? Divida.** Acima de ~30–40 páginas, mande por partes (ex.: "unidades
  1 a 3" numa conversa, "4 a 6" em outra). O prompt já avisa quando precisa cortar.
- **Peça ajustes pequenos, não recomeços.** "Troque a cor para azul-escuro" faz o
  ...
  o dobro.
- **Revisar não gasta.** Clicar nas abas, virar flashcard e refazer o quiz é local
  — só a **geração** consome mensagem.
...
- **Quantidade:** ajuste os intervalos de flashcards (8–12) e quiz (6–8).
